        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 relative items-start">
            ...
            <div className={`grid grid-cols-1 sm:grid-cols-2 ${isAiCopilotOpen ? 'xl:grid-cols-4 lg:grid-cols-2' : 'lg:grid-cols-4'} gap-4`}>
                ...
                <div className="flex items-start justify-between relative z-10">
                  <div>
                    <div className="flex items-center gap-1.5">
                      <h5 className="text-[10px] text-muted-foreground font-bold tracking-widest uppercase">Total Inspections</h5>
                      <Tooltip>
              ...
              <div className="bg-card rounded-xl border border-border p-5 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
                ...
                <div className="flex items-start justify-between relative z-10">
                  <div>
                    <div className="flex items-center gap-1.5">
                      <h5 className="text-[10px] text-muted-foreground font-bold tracking-widest uppercase">Conversion Rate</h5>
                      <Tooltip>
                        <TooltipTrigger asChild>
              ...
              <div className="bg-card rounded-xl border border-border p-5 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
                ...
                <div className="flex items-start justify-between relative z-10">
                  <div>
                    <div className="flex items-center gap-1.5">
                      <h5 className="text-[10px] text-muted-foreground font-bold tracking-widest uppercase">Cross-Commodity Backlog</h5>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button className="text-muted-foreground hover:text-[#7C3AED] transition-colors">
                            <Info className="w-3 h-3" />
                          </button>
                        </TooltipTrigger>
                        <TooltipContent side="top" className="max-w-[200px]">
                    ...
                    <p className="text-3xl text-[#7C3AED] dark:text-[#A78BFA] mt-1 font-extrabold tracking-tight">{kpiData.crossCommodityRate}%</p>
                  </div>
                  <div className="w-10 h-10 bg-[#7C3AED]/10 dark:bg-[#7C3AED]/5 rounded-xl flex items-center justify-center text-[#7C3AED] dark:text-[#A78BFA]">
              ...
              <div className="bg-card rounded-xl border border-border p-5 shadow-sm hover:shadow-md transition-all group overflow-hidden relative">
                ...
                <div className="flex items-start justify-between relative z-10">
                  <div>
                    <div className="flex items-center gap-1.5">
                      <h5 className="text-[10px] text-muted-foreground font-bold tracking-widest uppercase">Revenue Potential</h5>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button className="text-muted-foreground hover:text-brand-blue transition-colors">
                            <Info className="w-3 h-3" />
                          </button>
                        </TooltipTrigger>
                        <TooltipContent side="top" className="max-w-[200px]">
                  ...
                  <div className="w-10 h-10 bg-brand-blue/10 dark:bg-brand-blue/5 rounded-xl flex items-center justify-center text-brand-blue dark:text-accent">
          ...
          {isAiCopilotOpen ? (
            <div className="lg:col-span-3 lg:row-span-2 space-y-6 lg:sticky lg:top-6 self-start animate-in slide-in-from-right-8 duration-300">
              <div className="bg-gradient-to-b from-[#34D399] to-[#2DD4BF] rounded-2xl p-5 shadow-lg relative overflow-hidden border border-white/20 flex flex-col gap-4">
                ...
                <div className="flex items-start justify-between relative z-10 mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-teal-950 font-bold tracking-tight leading-tight">AI Copilot</h3>
                  </div>
                ...
                <div className="flex flex-col gap-4 relative z-10">
                  <div className="bg-white/40 backdrop-blur-xl rounded-xl p-4 border border-white/60 flex flex-col justify-between group hover:bg-white/60 transition-all shadow-sm">
                    <div className="flex items-center justify-between mb-2 text-teal-900"><h4 className="text-xs font-bold tracking-tight uppercase">High Probability PO</h4><span className="text-[9px] bg-red-500 text-white px-1.5 py-0.5 rounded font-bold">CRITICAL</span></div>
                    ...
                    <button className="text-[10px] font-bold text-white bg-teal-900 hover:bg-black transition-all py-2 px-3 rounded-lg w-full flex items-center justify-center gap-1.5 shadow-lg"><FileText className="w-3 h-3" /> Draft Bundling</button>
                  </div>
                  <div className="bg-white/40 backdrop-blur-xl rounded-xl p-4 border border-white/60 flex flex-col justify-between group hover:bg-white/60 transition-all shadow-sm">
                    <div className="flex items-center justify-between mb-2 text-teal-900"><h4 className="text-xs font-bold tracking-tight uppercase">Stock Shortage</h4><span className="text-[9px] bg-teal-700 text-white px-1.5 py-0.5 rounded font-bold">ANALYTIC</span></div>
                    <p className="text-[11px] text-teal-950/90 leading-relaxed font-bold mb-3">Shortage estimasi <span className="font-bold underline text-red-700">14 hari</span> di Gudang BJM.</p>
                    <button className="text-[10px] font-bold text-teal-900 bg-white/80 hover:bg-white transition-all py-2 px-3 rounded-lg w-full flex items-center justify-center gap-1.5 border border-teal-200"><ArrowUpRight className="w-3 h-3" /> Detail Stok</button>
                  </div>
                  <div className="bg-white/40 backdrop-blur-xl rounded-xl p-4 border border-white/60 flex flex-col justify-between group hover:bg-white/60 transition-all shadow-sm">
                    <div className="flex items-center justify-between mb-2 text-teal-900"><h4 className="text-xs font-bold tracking-tight uppercase">Force Balancing</h4><span className="text-[9px] bg-brand-blue text-white px-1.5 py-0.5 rounded font-bold">RESOURCE</span></div>
                    <p className="text-[11px] text-teal-950/90 leading-relaxed font-bold mb-3"><span className="font-bold">35% inspeksi</span> terfokus pada TYR. AI sarankan rotasi mekanik U/C ke Kaltim.</p>
                    <button className="text-[10px] font-bold text-blue-900 bg-white/80 hover:bg-white transition-all py-2 px-3 rounded-lg w-full flex items-center justify-center gap-1.5 border border-blue-200"><RefreshCw className="w-3.5 h-3.5" /> Rebalance Now</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className={`grid grid-cols-1 ${isAiCopilotOpen ? 'xl:grid-cols-3 lg:grid-cols-2' : 'lg:grid-cols-3'} gap-6`}>
              <div className="bg-card rounded-2xl border border-border overflow-hidden flex flex-col shadow-sm group hover:shadow-md transition-all">
                <div className="p-5 border-b border-border bg-muted/30 flex items-center justify-between">
                  <h4 className="text-sm font-bold text-primary dark:text-foreground flex items-center gap-2"><RefreshCw className="w-4 h-4 text-brand-green" /> Inventory Readiness & DOI</h4>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button className="text-muted-foreground hover:text-brand-green transition-colors">
                ...
                <div className="p-6 flex-1 flex flex-col justify-center">
                  <div className="flex items-end justify-between mb-2">
                    <p className="text-3xl font-bold text-brand-green tracking-tight">{internalStrategicKPIs.inventory.fulfillmentRatio}%</p>
                    <span className="text-[10px] font-bold text-brand-green bg-brand-green/10 px-2 py-0.5 rounded uppercase tracking-tighter">Healthy (Target &gt;85%)</span>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <div className="text-center"><p className="text-[10px] text-muted-foreground font-bold uppercase mb-0.5">Ready</p><p className="text-sm font-bold text-brand-green">{internalStrategicKPIs.inventory.readyInStock}%</p></div>
                      <div className="text-center border-x border-border"><p className="text-[10px] text-muted-foreground font-bold uppercase mb-0.5">Transit</p><p className="text-sm font-bold text-yellow-500">{internalStrategicKPIs.inventory.inTransit}%</p></div>
                      <div className="text-center"><p className="text-[10px] text-muted-foreground font-bold uppercase mb-0.5">OOS</p><p className="text-sm font-bold text-red-500">{internalStrategicKPIs.inventory.outOfStock}%</p></div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="bg-card rounded-2xl border border-border overflow-hidden flex flex-col shadow-sm group hover:shadow-md transition-all">
                <div className="p-5 border-b border-border bg-muted/30 flex items-center justify-between">
                  <h4 className="text-sm font-bold text-primary dark:text-foreground flex items-center gap-2"><Layers className="w-4 h-4 text-[#7C3AED]" /> Cross-Selling Success</h4>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button className="text-muted-foreground hover:text-[#7C3AED] transition-colors">
                        <Info className="w-3.5 h-3.5" />
                ...
                <div className="p-6 flex-1 flex flex-col gap-4">
                  <div className="bg-purple-500/5 rounded-xl p-4 border border-purple-500/10 flex items-center justify-between">
                    <div><p className="text-[10px] text-purple-700 dark:text-purple-400 font-bold uppercase mb-1">Avg Commodity/PO</p><p className="text-2xl font-bold text-[#7C3AED] dark:text-[#A78BFA] tracking-tight">{internalStrategicKPIs.commercial.avgCommodityPerPO}</p></div>
                    <div className="bg-[#7C3AED]/10 p-2 rounded-lg group-hover:bg-[#7C3AED] group-hover:text-white transition-colors"><TrendingUp className="w-5 h-5" /></div>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-muted/20 rounded-xl p-3 border border-border hover:border-purple-500/30 transition-colors"><p className="text-[9px] text-muted-foreground font-bold uppercase mb-0.5">Bundled Units</p><p className="text-lg font-bold text-primary dark:text-foreground">{internalStrategicKPIs.commercial.bundledUnits}</p></div>
                    <div className="bg-muted/20 rounded-xl p-3 border border-border hover:border-purple-500/30 transition-colors"><p className="text-[9px] text-muted-foreground font-bold uppercase mb-0.5">Conv. Rate</p><p className="text-lg font-bold text-primary dark:text-foreground">{internalStrategicKPIs.commercial.crossSellRate}%</p></div>
                  </div>
                </div>
              </div>
              <div className="bg-card rounded-2xl border border-border overflow-hidden flex flex-col shadow-sm group hover:shadow-md transition-all">
                <div className="p-5 border-b border-border bg-muted/30 flex items-center justify-between">
                  <h4 className="text-sm font-bold text-primary dark:text-foreground flex items-center gap-2"><Clock className="w-4 h-4 text-brand-blue" /> Backlog Aging</h4>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button className="text-muted-foreground hover:text-brand-blue transition-colors">
                        <Info className="w-3.5 h-3.5" />
                ...
                <div className="p-6 flex-1 flex flex-col justify-between">
                  <div className="flex items-baseline justify-between mb-4"><p className="text-sm text-muted-foreground font-bold">Avg. Speed to PO</p><p className="text-xl font-bold text-brand-blue tracking-tight">{internalStrategicKPIs.operations.avgLeadTimeToPO} Days</p></div>
                  <div className="space-y-2">
                    <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest mb-2">Backlog Pending</p>
                    <div className="flex h-8 rounded-lg overflow-hidden border border-border shadow-inner">
                      {internalStrategicKPIs.operations.agingBacklogs.map((item) => (<div key={item.category} className="h-full flex items-center justify-center text-[10px] font-bold text-white hover:opacity-80 transition-opacity" style={{ backgroundColor: item.color, width: `${(item.count / 54) * 100}%` }} title={`${item.category}: ${item.count}`}>{item.count > 5 && item.count}</div>))}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              <div className="lg:col-span-2 bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-all flex flex-col">
                <div className="flex items-start justify-between mb-2">
                  <div><h3 className="text-primary dark:text-foreground font-bold text-lg tracking-tight">Revenue Potential</h3><p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-0.5">By Commodity</p></div>
                  <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-xl bg-brand-blue/10 flex items-center justify-center text-brand-blue"><DollarSign className="w-5 h-5 font-bold" /></div>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button className="text-muted-foreground hover:text-brand-blue transition-colors">
                          <Info className="w-3.5 h-3.5" />
                ...
                <div className="mt-4 mb-6">
                   <p className="text-4xl font-bold text-primary tracking-tighter">{formatRupiah(kpiData.revenuePotential)}</p>
                   <div className="flex items-center gap-2 mt-2"><span className="text-[10px] text-brand-green font-bold bg-brand-green/10 px-2 py-0.5 rounded uppercase">+{kpiData.revenueDelta} Increase</span></div>
                </div>
                <div className="space-y-6 flex-1 flex flex-col justify-end">
                  <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest mb-2">Portfolio Breakdown</p>
              ...
              <div className="lg:col-span-3 bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-all">
                <div className="flex items-start justify-between mb-6">
                  <div><h3 className="text-primary dark:text-foreground font-bold text-lg tracking-tight">Plan vs Actual</h3><p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-0.5">Findings vs PO</p></div>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <button className="text-muted-foreground hover:text-primary transition-colors">
                        <Info className="w-3.5 h-3.5" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-1 bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-all flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-primary dark:text-foreground font-bold text-lg tracking-tight">Top 5 Customers</h3>
                    <h6 className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-0.5">By Revenue Potential</h6>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-xl bg-brand-navy/10 flex items-center justify-center text-brand-navy"><Users className="w-5 h-5 font-bold" /></div>
                    <Tooltip>
                      <TooltipTrigger asChild>
              ...
              <div className="lg:col-span-1 bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-all flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-primary dark:text-foreground font-bold text-lg tracking-tight">Density & Urgency</h3>
                    <h6 className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-0.5">Critical Findings Heat</h6>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-xl bg-red-500/10 flex items-center justify-center text-red-600"><AlertCircle className="w-5 h-5 font-bold" /></div>
                    <Tooltip>
                      <TooltipTrigger asChild>
              ...
              <div className="lg:col-span-1 bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-all flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-primary dark:text-foreground font-bold text-lg tracking-tight">Regional Revenue</h3>
                    <h6 className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-0.5">Contribution Heatmap</h6>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-xl bg-teal-500/10 flex items-center justify-center text-teal-600"><MapPin className="w-5 h-5 font-bold" /></div>
                    <Tooltip>
                      <TooltipTrigger asChild>
                    ...
                    return (
                      <div key={region.name} className="group cursor-pointer" onClick={() => setRegionFilter(region.name)}>
                        <div className="flex justify-between items-end mb-1">
                          ...
                          <span className="text-[10px] font-bold text-muted-foreground">{formatRupiah(region.value)}</span>
                        </div>
              ...
              <div className="lg:col-span-1 bg-card rounded-2xl border border-border p-6 shadow-sm hover:shadow-md transition-all flex flex-col">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-primary dark:text-foreground font-bold text-lg tracking-tight">Capture Rate (30D)</h3>
                    <h6 className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider mt-0.5">Conversion Efficiency</h6>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-10 h-10 rounded-xl bg-brand-green/10 flex items-center justify-center text-brand-green"><Target className="w-5 h-5 font-bold" /></div>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button className="text-muted-foreground hover:text-brand-green transition-colors">
                          <Info className="w-3.5 h-3.5" />
            ...
            <div className="bg-card rounded-2xl border border-border shadow-sm overflow-hidden transition-all hover:shadow-lg">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex items-center gap-2 bg-background border border-border rounded-xl px-2 shadow-inner h-9">
                    <Select value={statusFilter} onValueChange={setStatusFilter}>
                      <SelectTrigger className="w-[110px] h-7 text-[10px] font-bold border-none bg-transparent shadow-none focus:ring-0 uppercase tracking-tighter">
                    ...
                    <Select value={minBacklogFilter} onValueChange={setMinBacklogFilter}>
                      <SelectTrigger className="w-[120px] h-7 text-[10px] font-bold border-none bg-transparent shadow-none focus:ring-0 uppercase tracking-tighter">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left whitespace-nowrap border-separate border-spacing-0">
                  <thead className="bg-muted/50 text-[10px] uppercase font-bold tracking-widest text-muted-foreground/80 border-b border-border">
                  ...
                  <tbody className="divide-y divide-border/50">
                    {filtered.map((row) => (
                      <tr key={row.unitId} className="hover:bg-muted/30 transition-colors group cursor-pointer" onClick={() => navigate(`/unit/${row.unitId}`)}>
                        <td className="px-6 py-4 sticky left-0 z-10 bg-card group-hover:bg-muted/30 transition-colors border-r border-border/10"><div className="font-bold text-primary dark:text-foreground group-hover:text-brand-green mb-0.5">{row.unitId}</div><div className="text-[10px] text-muted-foreground font-bold">{row.model}</div></td>
                        ...
                        <td className="px-4 py-4 text-center">
                          {(() => {
                            ...
                            return (
                              <div className={`text-[10px] font-bold px-2 py-1 rounded-full inline-block ${total > 5 ? "bg-red-500 text-white" : total > 0 ? "bg-yellow-500/20 text-yellow-700" : "bg-muted text-muted-foreground"}`}>
                                {total} FINDINGS {isCritical && "🔥"}
                              </div>
                            );
                          })()}
                        </td>
                        <td className="px-6 py-4 text-right"><div className="text-xs font-bold text-primary dark:text-foreground">{formatRupiah(row.totalPoGap)}</div></td>
                        <td className="px-6 py-4 text-center"><div className={`text-[11px] font-bold px-2 py-1 rounded inline-block ${row.leadTimeAvg > 14 ? "bg-red-500/10 text-red-600" : row.leadTimeAvg > 7 ? "bg-yellow-500/10 text-yellow-600 dark:text-yellow-400" : "bg-muted/50 text-muted-foreground"}`}>{row.leadTimeAvg} DAYS</div></td>
                      </tr>
                    ))}
                    {filtered.length === 0 && (<tr><td colSpan={11} className="text-center py-20 text-muted-foreground font-bold italic">Search result empty. Re-sync database recommended.</td></tr>)}
                  </tbody>
                </table>
              </div>
              <div className="px-6 py-4 border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-muted/10">
                <div className="flex flex-wrap items-center gap-6">
                  <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-brand-green"></div><span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Normal</span></div>
                  <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-yellow-400"></div><span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Caution</span></div>
                  <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-red-500"></div><span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Critical (# Backlogs)</span></div>
                  <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-muted/40"></div><span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Unit N/A</span></div>
                </div>
                <div className="text-[9px] text-muted-foreground/60 font-bold uppercase tracking-widest">Real-time Data sync active — updated 2m ago</div>
              </div>
            </div>
          </div>
        </div>
