    ...
    <div className="flex items-start justify-between relative z-10">
      <div>
        <div className="flex items-center gap-1.5">
          <h5 className="text-[10px] text-muted-foreground font-bold tracking-widest uppercase">{title}</h5>
          <TooltipProvider>
            <ShadcnTooltip>
        ...
        <p className="text-3xl text-brand-navy dark:text-foreground mt-1 font-extrabold tracking-tight">{value}</p>
      </div>
    ...
    <div className="p-3 sm:p-6 space-y-4 sm:space-y-6 bg-background transition-colors duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto mt-4 sm:mt-0">
          ...
          <Button className="h-10 gap-2 bg-brand-navy dark:bg-brand-blue text-white rounded-lg text-xs font-bold shadow-md hover:opacity-90 transition-opacity">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 relative items-start">
        ...
        {isAiCopilotOpen ? (
          <div className="lg:col-span-3 space-y-6 lg:sticky lg:top-6 self-start animate-in slide-in-from-right-8 duration-300">
            <div className="bg-gradient-to-r from-[#34D399] to-[#2DD4BF] rounded-2xl p-5 shadow-lg relative overflow-hidden border border-white/20 flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4 relative z-10">
                <div className="bg-white/90 backdrop-blur-xl rounded-xl p-4 border border-white/60 flex flex-col justify-between group hover:bg-white transition-all shadow-sm">
                  <div className="flex items-center justify-between mb-2 text-teal-900">
                    <h4 className="text-[10px] font-bold tracking-tight uppercase">Coverage Alert</h4>
                    <span className="text-[9px] bg-red-500 text-white px-1.5 py-0.5 rounded font-bold">CRITICAL</span>
                  </div>
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-xl p-4 border border-white/60 flex flex-col justify-between group hover:bg-white transition-all shadow-sm">
                  <div className="flex items-center justify-between mb-2 text-teal-900">
                    <h4 className="text-[10px] font-bold tracking-tight uppercase">Resource Allocation</h4>
                    <span className="text-[9px] bg-brand-navy text-white px-1.5 py-0.5 rounded font-bold">OPTIMIZATION</span>
                  </div>
                  <p className="text-[11px] text-teal-950/90 leading-relaxed font-bold mb-3">
                    AI mengalokasikan <span className="font-bold underline text-brand-green">12% lebih banyak resources</span> ke area dengan backlog kritis.
                  </p>
                  <Button variant="outline" size="sm" className="text-[10px] font-bold text-teal-900 bg-white/50 hover:bg-white transition-all h-8 w-full flex items-center justify-center gap-1.5 border-teal-200">
                ...
                <div className="bg-white/90 backdrop-blur-xl rounded-xl p-4 border border-white/60 flex flex-col justify-between group hover:bg-white transition-all shadow-sm">
                  <div className="flex items-center justify-between mb-2 text-teal-900">
                    <h4 className="text-[10px] font-bold tracking-tight uppercase">Quality Insight</h4>
                    <span className="text-[9px] bg-teal-700 text-white px-1.5 py-0.5 rounded font-bold">ACHIEVEMENT</span>
                  </div>
                  <p className="text-[11px] text-teal-950/90 leading-relaxed font-bold mb-3">
                    Efisiensi Andi (Kalsel) <span className="font-bold underline text-teal-700">95%</span> lebih tinggi dari rata-rata nasional.
                  </p>
                  <Button variant="outline" size="sm" className="text-[10px] font-bold text-teal-900 bg-white/50 hover:bg-white transition-all h-8 w-full flex items-center justify-center gap-1.5 border-teal-200">
          ...
          <div className="fixed bottom-6 right-6 z-50">
            <button onClick={() => setIsAiCopilotOpen(true)} className="bg-gradient-to-r from-[#34D399] to-[#2DD4BF] text-teal-900 p-3 rounded-full shadow-xl hover:scale-110 transition-all flex items-center justify-center border border-white/40 group">
              ...
              <Table>
                <TableHeader className="bg-muted/30">
                  <TableRow>
                    ...
                    <TableHead className="px-6 py-4 font-bold text-primary uppercase text-[10px] tracking-widest text-right">Units (MTD)</TableHead>
                    <TableHead className="px-6 py-4 font-bold text-primary uppercase text-[10px] tracking-widest text-right">Critical Findings</TableHead>
                    <TableHead className="px-6 py-4 font-bold text-primary uppercase text-[10px] tracking-widest text-right">Est. Revenue</TableHead>
                    <TableHead className="px-6 py-4 font-bold text-primary uppercase text-[10px] tracking-widest text-center">Achievement</TableHead>
                    <TableHead className="px-6 py-4 font-bold text-primary uppercase text-[10px] tracking-widest text-center">Quality</TableHead>
                    ...
                    <TableRow key={idx} className="hover:bg-muted/30 transition-colors group cursor-pointer border-b border-border last:border-0">
                      ...
                      <TableCell className="px-6 py-4 text-center">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <span className="text-[10px] font-bold text-muted-foreground">{inspector.quality}%</span>
                        </div>
                      </TableCell>
                      <TableCell className="px-6 py-4 text-center">
                        <Button variant="ghost" size="icon" className="h-8 w-8 rounded-lg hover:bg-brand-green/10 hover:text-brand-green">
